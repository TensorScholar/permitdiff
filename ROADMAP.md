...
## v0.3 — policy analysis

- [ ] deterministic shadowed-rule diagnostics;
- [ ] threshold-boundary scenario suggestions;
- [ ] corpus ownership and freshness policies;
- [ ] compatibility report for schema upgrades.

## Explicit non-goals

Runtime authorization, approval orchestration, identity management, agent execution, tool sandboxing, model-based judges, and a hosted dashboard are not planned for the core package.
